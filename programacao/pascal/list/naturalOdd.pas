...
begin // principal
    info:= 'y';
    writeln; writeln('Número ímpares. Digite y para jogar.'); read(info);
    ...
    begin
        ...
        begin
            ...
            writeln; writeln; writeln('Digite um número negativo para sair.');
    ...
    writeln; writeln; writeln('Fim de jogo.');
end.    